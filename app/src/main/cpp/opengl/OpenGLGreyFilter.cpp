...
OpenGLGreyFilter::OpenGLGreyFilter() {
...
void OpenGLGreyFilter::onCreate() {
    if(ISDEBUG){
...
void OpenGLGreyFilter::onChange(int width, int height) {
...
void OpenGLGreyFilter::setPixels(void *pixels, int picWidth, int picHeight) {
...
void OpenGLGreyFilter::setMatriex() {
    init(matriex);
...
void OpenGLGreyFilter::onDestory() {
